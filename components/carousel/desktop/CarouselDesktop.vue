    ...
    <div id="carouselIndex" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="@/public/images/news/desktop/budokai.jpg" class="img-carousel" alt="budokai">
            </div>
            <div class="carousel-item">
                <img src="@/public/images/news/desktop/db-legends.jpg" class="img-carousel" alt="dbLegends">
            </div>
            <div class="carousel-item">
                <img src="@/public/images/news/desktop/saga-superheroes.png" class="img-carousel" alt="newSaga">
            </div>
        </div>
