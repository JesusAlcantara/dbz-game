    ...
    <div id="carouselIndex" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="@/public/images/news/mobile/budokai.jpg" class="img-carousel" alt="budokai">
            </div>
            <div class="carousel-item">
                <img src="@/public/images/news/mobile/db-legends.png" class="img-carousel" alt="dbLegends">
            </div>
            <div class="carousel-item">
                <img src="@/public/images/news/mobile/saga-superheroes.jpeg" class="img-carousel" alt="newSaga">
            </div>
        </div>
